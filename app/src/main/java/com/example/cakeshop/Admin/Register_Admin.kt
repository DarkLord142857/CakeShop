...
@Composable
fun Register_Manager(navController: NavController){
           ...
           Column(
               ...
               Button(
                   ...
                   onClick = {
                       ...
                       if(adminName.isEmpty() || passWord.isEmpty() || reEnterPassWord.isEmpty()){
               ...
               if (textTrue.isNotEmpty() && adminName.isNotEmpty() && passWord.isNotEmpty() && reEnterPassWord.isNotEmpty()){
